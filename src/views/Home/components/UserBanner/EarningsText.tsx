...
export const getEarningsText = (
  ...
  if (numFarmsToCollect > 0 && hasCakePoolToCollect) {
    if (numFarmsToCollect > 1) {
      earningsText = t('%earningsBusd% to collect from %count% farms and MYC pool', data)
    } else {
      earningsText = t('%earningsBusd% to collect from %count% farm and MYC pool', data)
    }
    ...
    earningsText = t('%earningsBusd% to collect from MYC pool', data)
  }
